...
const Solutions = () => {
  return (
    <div className="w-full h-full bg-[#EEEEEE] text-[#171717] flex flex-col justify-between py-12 px-6 md:py-28 md:px-16 select-none overflow-hidden box-border">
      {/* Top Section */}
      <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-8 md:gap-16">
        {/* Left: Title */}
        <h2 className="font-montreal font-normal text-left tracking-[0.04em] leading-[1.2] text-[#444444] max-w-[650px] text-[32px] md:text-[52px]">
          Luxury Fragrance<br className="hidden sm:inline" /> Solutions, Designed For<br className="hidden sm:inline" /> Every Space.
        </h2>

        {/* Right: Subtext */}
        <p className="font-montreal font-normal text-left md:text-right tracking-[0.04em] leading-[1.5] text-[#171717] max-w-[650px] text-[16px] md:text-[22px]">
      ...
      <div className="solutions-grid gap-x-4 lg:gap-x-4 mt-10 md:mt-16">
        {/* Column 1 */}
        <div className="solutions-card text-left">
          ...
          <h3 className="font-montreal font-bold text-[22px] md:text-[24px] tracking-[0.04em] leading-[1.2] text-[#171717]">
            Professional Installation
          </h3>
          <p className="font-montreal font-normal text-[16px] tracking-[0.04em] leading-[1.6] text-[#606060] pt-12 md:pt-32">
