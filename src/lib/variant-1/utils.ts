...
/**
 * Creates a thin vertical plane geometry for static indicator/framing lines
 */
export function createLinePlaneGeometry(
  gl: WebGLRenderingContext,
  width: number,
  height: number
) {
  ...
  // 4 vertices of a plane facing along positive Z axis
